...
const Investments = ({ investments = [], openModal, handleDelete, handleEdit, currency, exchangeRate = 1 }) => {
  ...
  const getBadgeColor = (cat) => {
    ...
    // Light Theme
    switch(cat) {
        case 'Crypto': return `${base} bg-orange-100 text-orange-700 border-orange-300`
        case 'Gold': return `${base} bg-yellow-100 text-yellow-700 border-yellow-300`
        default: return `${base} bg-[#F5F5DC] text-[#4B3621] border-[#654321]/30`
    }
  }
                             ...
                             <div className="col-span-3 flex items-center gap-4 overflow-hidden">
                                 ...
                                 <div className="min-w-0">
                                     ...
                                     <div className="flex items-center gap-2 mt-1">
                                        <span className={`text-[10px] font-mono tracking-wide ${theme === 'dark' ? 'text-gray-500' : 'text-[#654321]/60'}`}>{inv.ticker}</span>
                                     </div>
                                 </div>
                             </div>
