      ...
      <div className="flex-1 flex flex-col relative min-w-0">
        ...
        <header className="h-16 border-b border-white/5 flex justify-between items-center px-8 bg-[#0b0c15] shrink-0">
          ...
          <div className="flex items-center gap-6">
             <div className="relative">
                ...
                {showNotifications && (
                  <div className="absolute right-0 top-12 w-80 bg-[#09090b]/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl p-4 animate-fade-in z-50">
                    <div className="flex justify-between items-center mb-3"><h4 className="font-bold text-sm text-white">Notifications ({activeAlerts.length})</h4><button onClick={handleClearNotifications} title="Clear All" className="p-1 hover:bg-white/10 rounded-full text-gray-400 hover:text-white transition"><X size={16} /></button></div>
             ...
             <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-cyan-500 to-blue-600 border border-white/20 shadow-lg shadow-cyan-500/20"></div>
          </div>
        </header>
