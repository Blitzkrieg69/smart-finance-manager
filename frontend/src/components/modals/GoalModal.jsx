...
// FIX 1: use env var like every other file, not hardcoded 127.0.0.1
...
const GoalModal = ({ isOpen, onClose, initialData, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // FIX 2: withCredentials on both calls for session auth
      if (recordId) await axios.put(`${API_URL}/goals/${recordId}`, form, { withCredentials: true })
      else await axios.post(`${API_URL}/goals`, form, { withCredentials: true })
      onSuccess()
      onClose()
    } catch (e) {
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="relative">
            ...
            {activeCalendar && (
              <div className="absolute top-full left-0 z-50 mt-2" onClick={(e) => e.stopPropagation()}>
                <CustomCalendar
